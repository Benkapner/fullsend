...
If you find a potential security vulnerability in fullsend, please report it by following these steps:
...
2. Select the [**Security**](https://github.com/fullsend-ai/fullsend/security) tab.
