...
| [Harness Composition](docs/contributing/harness-composition.md) | Changing merge, diff, or path-rewriting functions in `internal/harness/` or `internal/cli/migrate.go` — covers the bidirectional invariant between compose and migration code |
