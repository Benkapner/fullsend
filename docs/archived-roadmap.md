...
>
> This file preserves **previously published** versions of `docs/roadmap.md` and permanent milestone sections (for example Foundation / April–May 2026) that rotate off the live [roadmap](roadmap.md) when planning horizons advance.
>
> **For humans and AI reviewers:** treat everything below as historical. Links, issue numbers, ADR references, and priority ordering may be stale, renumbered, closed, or wrong relative to current `main`. Do not use this file to infer current commitments, delivery dates, or tracking. Prefer [roadmap.md](roadmap.md) for what the project is building now.
>
> Snapshots are taken from git history at the commits noted in each section heading. Content is reproduced largely as published; minor formatting may differ from the original file on disk.

Live roadmap: [roadmap.md](roadmap.md)

---

## Quick reference: durable milestones rotated off the live roadmap

The August 2026 live roadmap keeps only the latest monthly done recap. The following blocks were on main through July 2026 and are preserved here in full (also inside the July snapshot below).
...
## Foundation era — May 2026 (post-MVP roadmap)

- **Published / captured:** 2026-05-14
- **Source commit:** [`739bf26d`](https://github.com/fullsend-ai/fullsend/commit/739bf26d)
- **Note:** Introduced the post-MVP Now/Next/Later structure and the Foundation (done) section after MVP.
...
## June 2026 planning refresh (early June draft)

- **Published / captured:** 2026-06
- **Source commit:** [`124dec4a`](https://github.com/fullsend-ai/fullsend/commit/124dec4a)
- **Note:** Early June refresh before the fuller June planning rewrite.
...
## June 2026 planning session roadmap

- **Published / captured:** 2026-06-09
- **Source commit:** [`36ac3a57`](https://github.com/fullsend-ai/fullsend/commit/36ac3a57)
- **Note:** Roadmap as revised after the June planning session.
...
## July 2026 planning refresh (as merged)

- **Published / captured:** 2026-07-09
- **Source commit:** [`0f47a193`](https://github.com/fullsend-ai/fullsend/commit/0f47a193)
- **Note:** July planning roadmap after review fixes (includes June 2026 done recap, ranked workstream categories, and Foundation April–May 2026). This is what lived on main until the August 2026 refresh.
